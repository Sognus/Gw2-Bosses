...
const float ENTRY_SEGMENTS_RING = 512.0f;
...
const std::string GW2BOSSES_RESOURCE_PAINTED_CIRCLE = "GW2BOSSES_RESOURCE_PAINTED_CIRCLE";
const std::string GW2BOSSES_RESOURCE_PAINTED_CIRCLE_TOP = "GW2BOSSES_RESOURCE_PAINTED_CIRCLE_TOP";
const std::string GW2BOSSES_RESOURCE_PAINTED_LINE = "GW2BOSSES_RESOURCE_PAINTED_LINE";